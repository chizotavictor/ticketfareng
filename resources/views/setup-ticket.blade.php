...
<div class="bg-white dark:bg-gray-900 dark:text-white text-gray-600 h-screen flex overflow-hidden text-sm">
  <div class="bg-orange-50 dark:bg-gray-900 dark:border-gray-800 w-20 flex-shrink-0 border-r border-gray-200 flex-col hidden sm:flex">
  ...
  <div class="flex-grow overflow-hidden h-full flex flex-col">
    <div class="h-40 lg:flex w-full border-b border-gray-200 dark:border-gray-800 hidden px-10"
      style="padding-left: 1.5rem;">
      <div class="flex h-full text-gray-600 dark:text-gray-400">
        <h1 class="h-full border-b-2 border-transparent inline-flex items-center mr-8"
    ...
    <div class="flex-grow flex overflow-x-hidden">
      <div class="xl:w-72 w-48 flex-shrink-0 border-r border-gray-200 dark:border-gray-800 h-full overflow-y-auto no-scrollbar lg:block hidden p-5">
